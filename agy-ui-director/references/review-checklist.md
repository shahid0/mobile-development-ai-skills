...
- The visual-priority ladder is visible: dominant, strong, medium, low, and quiet elements do not all share the same weight.
- The dominant element or cluster is identifiable within a 3-second glance.
