...
Delete transitions that do not apply. Add domain-specific transitions only when backed by real state, such as recording, uploading, generating, saving, syncing, or completed.
